...
%\usepackage{fancyvrb}
%\usepackage{spverbatim} % потому что листингс не работает с кириллицей
...
\setmonofont[Mapping=]{PT Sans}
\newfontfamily\monospace[Mapping=]{PT Sans}
...
\begin{titlepage}
    \includegraphics[scale=0.15]{company_logo.png}
    \vspace*{\fill}
    \vspace{-5cm}
    $if(second_title)$
