...
**Warning! Alpha-stage software!** The API is unstable, and there are a lot of problems with the code. With 99% probability we will rewrite Foliant before 1.0, maybe multiple times.
